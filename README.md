...
`kubernetes/staging/src/github.com/lushenle/sample-controller` and its dependencies
...
```sh
kubectl delete crd Apps.samplecontroller.shenle.lu
```
...
https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/lushenle/sample-controller.
