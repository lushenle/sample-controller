...
import (
	...
	scheme "github.com/lushenle/sample-controller/pkg/generated/clientset/versioned/scheme"
...
func newApps(c *SamplecontrollerV1alpha1Client, namespace string) *apps {
	return &apps{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *apps) UpdateStatus(ctx context.Context, app *v1alpha1.App, opts v1.UpdateOptions) (result *v1alpha1.App, err error) {
	result = &v1alpha1.App{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apps").
